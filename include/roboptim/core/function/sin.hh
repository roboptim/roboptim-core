...
#ifndef ROBOPTIM_CORE_FUNCTION_SIN_HH
# define ROBOPTIM_CORE_FUNCTION_SIN_HH
...
namespace roboptim
{
  ...
  {
    jacobian.insert (0, 0) = std::cos (x[0]);
  }
  template <typename T>
  void
  Sin<T>::impl_jacobian
  ...
  Sin<EigenMatrixSparse>::impl_hessian (hessian_t& hessian,
					...
					size_type) const throw ()
  {
    hessian.insert (0, 0) = -std::sin (x[0]);
  }
...
#endif //! ROBOPTIM_CORE_FUNCTION_SIN_HH
