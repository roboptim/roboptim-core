...
# ifdef ROBOPTIM_PRECOMPILED_DENSE_SPARSE
  extern template class ROBOPTIM_CORE_DLLAPI Multiplexer<Solver<EigenMatrixDense> >;
  extern template class ROBOPTIM_CORE_DLLAPI Multiplexer<Solver<EigenMatrixSparse> >;
