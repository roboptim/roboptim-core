...
# ifdef ROBOPTIM_PRECOMPILED_DENSE_SPARSE
  ...
  extern template class ROBOPTIM_CORE_DLLAPI GenericFunction<EigenMatrixDense>;
  extern template class ROBOPTIM_CORE_DLLAPI GenericFunction<EigenMatrixSparse>;
