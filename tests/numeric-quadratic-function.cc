...
int run_test ()
{
  ...
  a(1, 0) = 2.1, a(1, 1) = 2.2, a(1, 2) = 2.3, a(1, 3) = 2.4, a(1, 4) = 2.5;
  a(2, 0) = 3.1, a(2, 1) = 3.2, a(2, 2) = 3.3, a(2, 3) = 3.4, a(2, 4) = 3.5;
  a(3, 0) = 4.1, a(3, 1) = 4.2, a(3, 2) = 4.3, a(3, 3) = 4.4, a(3, 4) = 4.5;
  a(4, 0) = 5.1, a(4, 1) = 5.2, a(4, 2) = 5.3, a(4, 3) = 5.4, a(4, 4) = 5.5;
