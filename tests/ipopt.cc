...
int run_test ()
{
  ...
  {
    typedef IpoptSolver<double (double)> solver_t;
    solver_t solver (_1);
  ...
  {
    typedef IpoptSolver<double (double, double)> solver_t;
  ...
  {
    typedef IpoptSolver<double (double, double, double, double)> solver_t;
